...
partial class FormSignIn
{
    ...
    private void InitializeComponent()
    {
        ...
        label1.Font = new Font("Microsoft Sans Serif", 36F, FontStyle.Regular, GraphicsUnit.Point, 163);
        ...
        BT_SignIn.Font = new Font("Microsoft Sans Serif", 13.7999992F, FontStyle.Bold, GraphicsUnit.Point, 163);
        ...
        LB_SignUp.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Bold, GraphicsUnit.Point, 163);
        LB_SignUp.ForeColor = Color.FromArgb(104, 202, 167);
        LB_SignUp.Location = new Point(373, 419);
        LB_SignUp.Name = "LB_SignUp";
        LB_SignUp.Size = new Size(89, 25);
        ...
        label3.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point, 163);
        ...
        LB_UserNameExisted.Font = new Font("Microsoft Sans Serif", 7.79999971F, FontStyle.Italic, GraphicsUnit.Point, 163);
        ...
        LB_UserNameExisted.Size = new Size(0, 16);
        ...
        LB_CautionLogin.Font = new Font("Microsoft Sans Serif", 7.79999971F, FontStyle.Italic, GraphicsUnit.Point, 163);
        LB_CautionLogin.ForeColor = Color.Red;
        LB_CautionLogin.Location = new Point(64, 284);
        LB_CautionLogin.Name = "LB_CautionLogin";
        LB_CautionLogin.Size = new Size(312, 16);
        ...
        lbForgotPassword.Font = new Font("Microsoft Sans Serif", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 163);
        lbForgotPassword.ForeColor = Color.Black;
        lbForgotPassword.Location = new Point(64, 314);
        lbForgotPassword.Name = "lbForgotPassword";
        lbForgotPassword.Size = new Size(184, 20);
        ...
        lbChangePassword.Font = new Font("Microsoft Sans Serif", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 163);
        lbChangePassword.ForeColor = Color.Black;
        lbChangePassword.Location = new Point(300, 314);
        lbChangePassword.Name = "lbChangePassword";
        lbChangePassword.Size = new Size(191, 20);
        lbChangePassword.TabIndex = 16;
        lbChangePassword.Text = "Change your Password?";
